...
<section id="dashboard-upvoted" class="mt-5">
  ...
  @empty
    <div class="flex flex-col h-screen">
        <div class="bg-yellow-100 p-4"><p>Sorry, there's nothing to see here. Looks like you haven't upvote to a post yet.</p></div>
    </div>
  @endforelse
