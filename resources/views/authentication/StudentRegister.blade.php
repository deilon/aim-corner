            ...
            <div class="row align-items-center">
                <div class="col col-lg-6 offset-lg-3">
                    <div class="d-flex mb-5 justify-content-between">
                        <h4 class="align-self-center text-center">📚 Student Registration Form</h4>
                    ...
                    <form action="{{ url('student/register') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="course" id="course" value="{{ old('course') }}">
                                <option value="">Select year and course</option>
                                <option value="BSIS1">Bachelor of Science in Information System (1st year)</option>
                                <option value="BSIS2">Bachelor of Science in Information System (2nd year)</option>
                                <option value="BSIS3">Bachelor of Science in Information System (3rd year)</option>
                                <option value="BSIS4">Bachelor of Science in Information System (4th year)</option>
                                <option value="ACT1">Associate in Computer Technology (1st year)</option>
                                <option value="ACT2">Associate in Computer Technology (2nd year)</option>
                            </select>
